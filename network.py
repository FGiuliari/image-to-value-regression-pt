...
class Net(nn.Module):
    ...
    def __init__(self, input_shape, vgg16_basemodel=True, batch_normalization=False, dropout=False):
        ...
        if self.use_base_model:
            ...
            self.conv3x3_1 = nn.Conv2d(input_shape[0], 4, 3, padding=1)
            self.conv3x3_1_bn = nn.BatchNorm2d(4)
            self.conv5x5_1 = nn.Conv2d(input_shape[0], 4, 5, padding=2)
            self.conv5x5_1_bn = nn.BatchNorm2d(4)
            self.conv7x7_1 = nn.Conv2d(input_shape[0], 4, 7, padding=3)
            self.conv7x7_1_bn = nn.BatchNorm2d(4)
            
            self.conv3x3_2 = nn.Conv2d(4, 8, 3, padding=1)
            self.conv3x3_2_bn = nn.BatchNorm2d(8)
            self.conv5x5_2 = nn.Conv2d(4, 8, 5, padding=2)
            self.conv5x5_2_bn = nn.BatchNorm2d(8)
            self.conv7x7_2 = nn.Conv2d(4, 8, 7, padding=3)
            self.conv7x7_2_bn = nn.BatchNorm2d(8)
